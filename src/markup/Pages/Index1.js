...
const iconBlog2 = [
	{ icon:  <i className="flaticon-rattle text-blue" />, title: 'Early Years Foundation', },	
	{ icon:  <i className="flaticon-bricks text-green" />, title: 'Lower Grader', },	
	{ icon:  <i className="flaticon-puzzle text-orange" />, title: 'Upper Grader',  },	
];
